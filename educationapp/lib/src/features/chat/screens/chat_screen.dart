...
import 'package:educationapp/src/features/chat/components/message_tile.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool _loading = false;
  static const _apiKey = 'AIzaSyBJ2XYcU5BCCCjMZ4M0x_B2ZfKba6Fffx0'; // https://ai.google.dev/ (Get API key from this link)
                ...
                children: [
                  Expanded(
                    child: SizedBox(
                      height: 55,
                      child: TextField(
                        cursorColor: const Color.fromARGB(255, 124, 1, 246),
